                ...
                <section className="services">
                    ...
                    <div className="service-container">
                      ...
                      <div className="service-description">
                          ...
                          <div>During the ACM ICPC, you must solve difficult tasks, which are not for ordinary programmers. While you are training, you learn how to solve these out of the ordinary tasks. This helps prepare you for a job because you can adapt and solve various types of problems, in various types of situations.</div>
                      </div>
                    </div>
